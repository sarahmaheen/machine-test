...
function createEmployeeValidations() {
    return [
        ...
        body('designation','designation is required').notEmpty().isLength({min:2,max:30}),
        body('gender','gender is required').notEmpty().isLength({min:2,max:30}),
        body('course','course is required').notEmpty().isLength({min:2,max:30}),
